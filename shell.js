...
(function () {
  ...
  var GROUPS = [
    ...
    { name: 'Safety', items: ['incidents.html', 'compliance.html', 'retention.html', 'handbooks.html'] },
  ...
  var ICON = {
    'index.html': '◎', 'dispatch.html': '▤', 'messages.html': '✉', 'ratings.html': '★', 'incidents.html': '⚠', 'retention.html': '♥', 'handbooks.html': '▭', 'compliance.html': '☑', 'getting-started.html': '✓', 'templates.html': '↻', 'loads.html': '▸', 'containers.html': '▦',
