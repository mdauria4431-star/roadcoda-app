...
(function () {
  ...
  const NAMES = { dispatch: 'Dispatch', loads: 'Loads', customers: 'Customers', drivers: 'Drivers', equipment: 'Equipment', rates: 'Rates',
                  invoices: 'Invoices', tolls: 'Tolls', payroll: 'Payroll', money: 'Profit (needs the money switch)', safety: 'Incidents', containers: 'Containers', office_payroll: 'Office payroll', integrations: 'Integrations', users: 'Users' };
  ...
  async function run() {
    ...
    if (nav) {
      ...
      const FULL = [['index.html', 'Home'], ['dispatch.html', 'Dispatch'], ['messages.html', 'Messages'], ['ratings.html', 'Ratings'],
        ...
        ['payroll.html', 'Payroll'], ['office-payroll.html', 'Office payroll'], ['profit.html', 'Profit'], ['tolls.html', 'Tolls'], ['incidents.html', 'Incidents'], ['retention.html', 'Retention'], ['handbooks.html', 'Handbooks'],
