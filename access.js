  ...
  async function run() {
    ...
    if (nav) {
      ...
      const FULL = [['index.html', 'Home'], ['dispatch.html', 'Dispatch'], ['messages.html', 'Messages'], ['ratings.html', 'Ratings'],
        ...
        ['payroll.html', 'Payroll'], ['office-payroll.html', 'Office payroll'], ['profit.html', 'Profit'], ['tolls.html', 'Tolls'], ['incidents.html', 'Incidents'], ['retention.html', 'Retention'],
